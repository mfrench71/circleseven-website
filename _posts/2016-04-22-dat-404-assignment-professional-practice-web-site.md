...
Following on from my [investigation ]({{ site.baseurl }}/2016-29-dat-404-web-technologies-assignment-preparation/)[into visual effects provider web sites]({{ site.baseurl }}/dat-404-web-technologies-assignment-preparation/) and the creation of three alternative web designs based on these web sites, I decided to turn the following Photoshop mockup into a completed smash page web design for my chosen professional practice of broadcast visual effects:
