...
Now having had a taste of [Blender](http://www.blender.org) as part of my [DAT406 university assignment]({{ site.baseurl }}/dat-406-assignment-part-2-the-multiverse/), I was keen to repeat the learning process and so decided to use the same tutorial. This time I would apply the techniques, albeit it in a slightly less polished and refined form than in Joe's tutorial, to Blender. This is the result...
