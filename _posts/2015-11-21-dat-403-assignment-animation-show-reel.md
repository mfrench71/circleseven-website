...
The background reflects my theme of red, amber and green: the colours used in my 'Greenlight Design' [corporate identity assets]({{ site.baseurl }}/dat-403-assignment-corporate-identity-design/), and provides a subtle background for the main part of the animation.
