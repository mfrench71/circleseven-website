...
description: "After Effects animation showreel featuring particle explosions, audio visualisation, character animation and corporate identity motion graphics."
---
...
The background reflects my theme of red, amber and green: the colours used in my 'Greenlight Design' [corporate identity assets]({{ site.baseurl }}/dat403-assignment-corporate-identity-design/), and provides a subtle background for the main part of the animation.
