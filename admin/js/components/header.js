      ...
      <div class="px-4 py-2">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="ms-auto d-flex align-items-center gap-3">
            ...
            <button onclick="if (window.netlifyIdentity) netlifyIdentity.logout();" class="btn btn-link text-secondary text-decoration-none d-flex align-items-center gap-2">
